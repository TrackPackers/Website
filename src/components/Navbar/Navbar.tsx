...
function Navbar(props: Props) {
    ...
    return (
                ...
                <div className="flex space-x-4">
                    ...
                    <div>
                        <div className="relative">
                            <input type="text" placeholder="Search" className="pl-10 input input-bordered"/>
        ...
        {  props.authenticated ? (
                <div className="flex space-x-4">
                    <label htmlFor="new-post-modal" className="text-white btn btn-primary">Create post</label>

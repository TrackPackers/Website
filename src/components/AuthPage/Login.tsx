  ...
  return (
    <div className="container w-full h-full lg:w-screen">
      <div className="flex flex-col items-center justify-center">
        <div className="w-full p-10 mt-16 rounded shadow-md shadow-black bg-slate-100 lg:w-1/3 md:w-1/2">
          <p
            tabIndex={0}
            role="heading"
          ...
          <p className="mt-4 text-sm font-medium leading-none text-gray-500">
            ...
            <a
              ...
              onClick={() => props.handleSwitchButton(false)}
          ...
          <div className="flex items-center justify-between w-full py-5">
            ...
            <hr className="w-full bg-gray-600" color="#55555" />
          </div>
          <div>
            <input
